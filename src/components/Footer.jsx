    ...
    <footer style={{background:'#1a1a1a',color:'#ccc',padding:'64px 0 32px'}}>
      <div className="container">
        <div style={{display:'grid',gridTemplateColumns:'2fr 1fr 1fr 1fr',gap:48,marginBottom:48}}>
          ...
          <div>
            ...
            <div style={{display:'flex',flexDirection:'column',gap:10}}>
              ...
              <a href="mailto:hello@jokersjunk.com" style={{color:'#999',fontSize:'.88rem'}}>📧 hello@jokersjunk.com</a>
        ...
        <div style={{borderTop:'1px solid #2a2a2a',paddingTop:28,display:'flex',justifyContent:'space-between',flexWrap:'wrap',gap:12}}>
          <div style={{fontSize:'.82rem',color:'#555'}}>© 2026 Jokers Junk Removal LLC · All Rights Reserved · Florida</div>
